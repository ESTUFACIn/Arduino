...
void loop(void) 
{
  ...
  Serial.print(ads_ch0);    Serial.print("\t\t");   Serial.print(ads_Temperature_ch0, 3);       Serial.print("\t\t");     Serial.print(ads_bit_Voltage, 10);     Serial.print("\t\t");
  Serial.println();
